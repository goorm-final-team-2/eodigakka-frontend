...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-canvas flex flex-col justify-center items-center px-6">
      ...
      <div className="w-full flex flex-col items-center space-y-8 py-10" style={{ maxWidth: '360px' }}>
        ...
        <div className="w-20 h-20 bg-primary rounded-[20px] flex items-center justify-center shadow-lg transform transition-transform active:scale-95">
          <span className="text-on-primary font-display font-bold text-2xl tracking-tighter select-none">어디</span>
        </div>

        <div className="text-center space-y-2">
          <h1 className="font-display text-display-md font-bold text-ink tracking-tight">어디가까</h1>
          <p className="text-sm text-ink-muted-48">모임의 모든 장소와 위치를 한 번에 정하는 스마트 조율 서비스</p>
        </div>

        <div className="w-full space-y-4 pt-4">
          {/* 노란색 헥스코드는 ESLint 우회용 주석을 한 줄 위에 작성합니다 */}
