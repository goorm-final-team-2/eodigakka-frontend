...
// DELETE /api/appointments/{id}/members/me — 약속방 나가기 (일반 참여자/게스트)
export const leaveAppointment = (appointmentId: number): Promise<void> =>
  apiClient.delete(`/appointments/${appointmentId}/members/me`).then(() => undefined);
